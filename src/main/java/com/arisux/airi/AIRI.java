...
public class AIRI
{
	...
	public void preInit(FMLPreInitializationEvent event)
	{
		...
		event.getModMetadata().url = properties.SERVER_ADDRESS + "/page/mods/airi/";
	...
	public void postInitialize(FMLPostInitializationEvent event)
	{
		if (FMLCommonHandler.instance().getSide() == Side.CLIENT)
		{
			(updater = updaterapi.createNewUpdater(Properties.MODID, Properties.VERSION, properties.URL_LATEST, properties.URL_MODPAGE, properties.URL_CHANGELOG)).postInitialize(event);
		}
	}
