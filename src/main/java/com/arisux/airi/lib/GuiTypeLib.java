...
public class GuiTypeLib
{
	...
	public static class GuiCustomButton extends GuiButton
	{
		...
		{
			this.drawButton(Minecraft.getMinecraft(), (int) RenderLib.scaledMousePosition().x, (int) RenderLib.scaledMousePosition().y);
		}
		...
		public void drawButton(Minecraft mc, int mouseX, int mouseY)
		{
			if (this.visible)
			{
				...
				RenderLib.drawRect(this.xPosition, this.yPosition, this.width, this.height, baseColor);
				RenderLib.drawRect(this.xPosition, this.yPosition, this.width, this.height, overlayColor);
				...
				{
					RenderLib.drawToolTip((int) RenderLib.scaledMousePosition().x + 10, (int) RenderLib.scaledMousePosition().y, tooltip);
				}
			}
		}
	...
	public static class GuiCustomTextbox extends GuiTextField
	{
		...
		{
			int mouseX = (int) RenderLib.scaledMousePosition().x;
			int mouseY = (int) RenderLib.scaledMousePosition().y;
	...
	public static class GuiCustomSlider extends GuiCustomButton
	{
		...
		public void drawButton(Minecraft mc, int mouseX, int mouseY)
		{
			...
			if (this.visible)
			{
				RenderLib.drawRectWithOutline(this.xPosition - 1, this.yPosition - 1, this.width + 2, this.height + 2, 1, 0x00000000, 0xAAFFFFFF);
				RenderLib.drawRect(this.xPosition + (int) (this.sliderValue * (float) (this.width - 8)), this.yPosition, 8, this.height, sliderButtonColor);
			}
		}
	...
	public static int handleMouseInputForCustomButton(GuiCustomButton button)
	{
		if (Mouse.isCreated())
		{
			Vector2d mousePosition = RenderLib.scaledMousePosition();
